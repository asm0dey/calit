...
public class OidcLoginResource {
    ...
    public Response login() {
        ...
        return dropOidcSession(Response
            .ok(GoogleLoginResource.Templates.bridge(user.username, token))
    ...
    private static Response.ResponseBuilder dropOidcSession(Response.ResponseBuilder b) {
        ...
        return b.cookie(new NewCookie.Builder(OIDC_SESSION_COOKIE).path("/").maxAge(0).build());
    }
