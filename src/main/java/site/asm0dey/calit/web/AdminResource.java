...
public class AdminResource {
    ...
    private long pendingCount() {
        return Booking.count("ownerId = ?1 and status = ?2",
                currentOwner.id(), site.asm0dey.calit.booking.BookingStatus.PENDING);
    }
    ...
    public TemplateInstance dashboard() {
        ...
        List<Booking> upcoming = Booking.list(
                ...
                currentOwner.id(), site.asm0dey.calit.booking.BookingStatus.CONFIRMED, java.time.Instant.now());
