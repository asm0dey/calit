...
public final class PersonalData {
    ...
    public static final List<Classified> TABLES = List
        .of(
                // --- invitee / guest data -----------------------------------------------------------
                new Classified(
                        "booking",
                        ...
                        Set
                            ...
                            .of("invitee_name", "invitee_email", "answers", "meet_link", "title", "description"),
                        Subject.INVITEE,
                ...
                new Classified(
                        ...
                        Set
                            ...
                            .of("name", "description", "location_detail"),
                        Subject.OWNER,
                        EraseRoute.CASCADES
                ),
                new Classified(
