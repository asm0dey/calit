 ...
 * id. A null ref — or a ref with a null calendar id — means "resolve the owner's write target",
 * which is what every write did before calit-rma2 and what pre-V26 bookings still get.
 *
