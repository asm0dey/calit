...
class AppLocalesTest {
    ...
    void acceptLanguagePicksBestSupported() {
        assertEquals(Locale.GERMAN, AppLocales.fromAcceptLanguage("fr-FR,fr;q=0.9,de;q=0.8,en;q=0.7", LOCALES));
    }

    @Test
    void acceptLanguageNoneSupportedIsDefault() {
        assertEquals(AppLocales.DEFAULT, AppLocales.fromAcceptLanguage("fr-FR,fr;q=0.9", LOCALES));
    }
