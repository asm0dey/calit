...
class GooglePageResourceTest {
    ...
    long[] seedHealthyXAndFlaggedY() {
        ...
        yr.ownerId = ownerId;
        yr.googleCredentialId = y.id;
        yr.googleCalendarId = "y1";
        yr.summary = "Y1";
        yr.readForBusy = true;
        yr.writeTarget = false;
        yr.persist();
    ...
    long seedTwoAccountsWriteOnFirst() {
        ...
        w.ownerId = ownerId;
        w.googleCredentialId = a.id;
        w.googleCalendarId = "w";
        w.summary = "W";
        w.readForBusy = true;
        w.writeTarget = true;
        w.persist();
