...
class BookingPostTest {
    ...
    void postSetsBookingOwnerIdFromResolvedUser() {
        ...
        Booking b = Booking.find("inviteeEmail = ?1 and status <> ?2", "owned@example.com", BookingStatus.CANCELLED)
                .firstResult();
        org.junit.jupiter.api.Assertions.assertNotNull(b, "booking must be created");
        org.junit.jupiter.api.Assertions.assertEquals(
                seededOwnerId, b.ownerId, "Booking.ownerId must be the resolved /{user} owner");
    }
}
