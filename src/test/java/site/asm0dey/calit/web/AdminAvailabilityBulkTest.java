...
class AdminAvailabilityBulkTest {
    ...
    void bulkSaveReplacesAllGlobalRules() {
        ...
        given()
            ...
            .formParam("startTime", "08:00")
            .formParam("endTime", "09:00")
    ...
    void bulkSaveSkipsBlankAndInvertedFrames() {
        ...
        given()
            ...
            // blank start; inverted end<=start
            .formParam(
                    // blank start; inverted end<=start
                    "frameStart",
                    // blank start; inverted end<=start
    ...
    void bulkSavePerTypeReplacesOnlyThatTypesRules() {
        ...
        given()
            .cookie("quarkus-credential", cred)
            .contentType("application/x-www-form-urlencoded")
            .formParam("name", "Bulk Type")
            .formParam("slug", "bulk-type")
        ...
        given()
            ...
            .formParam("endTime", "09:00")
            .when()
            .post("/me/meeting-types/" + t.id + "/availability")
            .then()
            .statusCode(200);
    ...
    void bulkSavesAreScopeIsolated() {
        ...
        given()
            .cookie("quarkus-credential", cred)
            .contentType("application/x-www-form-urlencoded")
            .formParam("name", "Iso Type")
            .formParam("slug", "iso-type")
            .formParam("durationMinutes", "30")
            .formParam("minNoticeMinutes", "0")
            .formParam("horizonDays", "30")
            .formParam("locationType", "PHONE")
    ...
    void typeDetailRendersSevenDayGrid() {
        ...
        given()
            .cookie("quarkus-credential", cred)
            .contentType("application/x-www-form-urlencoded")
            .formParam("name", "Grid Type")
            .formParam("slug", "grid-type")
            .formParam("durationMinutes", "30")
            .formParam("minNoticeMinutes", "0")
            .formParam("horizonDays", "30")
            .formParam("locationType", "PHONE")
            ...
            .then()
            .statusCode(200);
        MeetingType t = site.asm0dey.calit.domain.MeetingType.find("slug = ?1", "grid-type").firstResult();
