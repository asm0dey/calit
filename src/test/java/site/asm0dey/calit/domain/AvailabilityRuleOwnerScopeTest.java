...
class AvailabilityRuleOwnerScopeTest {
    ...
    void globalForOwnerReturnsOnlyThatOwnersGlobalRules() {
        ...
        mt.ownerId = 4001L; mt.name = "Typed"; mt.slug = "avail-scope-typed"; mt.durationMinutes = 30;
        mt.persist();
        AvailabilityRule typed = new AvailabilityRule();
        typed.ownerId = 4001L; typed.meetingTypeId = mt.id; typed.dayOfWeek = DayOfWeek.MONDAY;
