...
- [x] Decide where seeding belongs: the `/me/setup` first-login wizard, or user creation itself (so an admin-created user is seeded too)
- [x] Wire `weekdayDefaults()` there, stamping `owner_id`
